...
const whyUsCards = [
  {
    ...
    description:
      "Reliable and secure platform with verified listings for peace of mind in your property search.",
    svg: (
      <svg
        height={32}
        width={32}
  ...
  },
  {
    ...
    description:
      "Discover competitive pricing on a wide range of properties to fit your budget.",
    svg: (
      <svg
        className="fill-accent-green-100"
        width={32}
  ...
  },
  {
    title: "Quick Process",
    description:
      "Streamlined procedures to help you find and secure your ideal property swiftly.",
    svg: (
      <svg
        height={32}
        width={32}
  ...
  },
  {
    title: "Easy To Find",
    description:
      "User-friendly search features make finding your perfect property simple and efficient.",
    svg: (
      <svg
        height={32}
        width={32}
  ...
  return (
    <div className="flex flex-col gap-8 sm:gap-12">
      <div className="flex md:flex-row flex-col items-center gap-6">
        <div className="flex-[1.5] md:order-2">
          <Image
            src={aboutImage1}
            alt=""
        ...
        <div className="flex flex-col flex-1 gap-4">
          <h1 className="font-bold text-2xl lg:text-3xl">About Estate Haven</h1>
          <p className="sm:text-base text-sm text-zinc-500">
            Discover a variety of properties, from luxury homes to
            budget-friendly options. Our user-friendly platform ensures a
            seamless and enjoyable property search.
          </p>
          <Link
            href={"/contact"}
            className="flex items-center gap-2 bg-accent-green-100 hover:bg-accent-green-200 sm:px-6 px-4 sm:py-3 py-2 rounded-md w-fit font-bold text-white sm:text-base text-sm duration-300"
          >
            <svg
              height={18}
              width={18}
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="gap-4 grid sm:grid-cols-2 lg:grid-cols-4 text-center">
          {whyUsCards.map((card, index) => (
            <div
              key={index}
              className="flex-col flex-center gap-2 shadow-[#eee] shadow-[0_0_10px_1px] p-6 rounded-xl"
            >
              {card.svg}
      ...
      <div className="flex items-center gap-8 bg-[#f6f6f6] p-8 sm:p-10 rounded-xl">
        <div className="flex flex-col flex-1 gap-4">
          <h2 className="font-bold text-xl sm:text-2xl">
            Buy properties with confidence, sell without pressure
          </h2>
          <p className="sm:text-base text-sm text-zinc-500">
            Experience seamless transactions and exceptional service, making
            your buying and selling journey stress-free and successful.
          </p>
          <Link
            href={"/properties"}
            className="bg-accent-green-100 flex items-center gap-2 hover:bg-accent-green-200 sm:px-6 px-4 sm:py-3 py-2 rounded-md w-fit font-bold text-white sm:text-base text-sm duration-300"
          >
            <svg
              width={18}
              height={18}
