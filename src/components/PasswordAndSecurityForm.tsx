...
export default function PasswordAndSecurityForm() {
  ...
  return (
    <form
      ...
      ref={formRef}
    >
      <div className="relative flex flex-col gap-1 border-zinc-100">
        ...
        <div className="relative flex flex-col gap-2">
          <div className="relative flex flex-col gap-2">
            ...
            <button
              type="button"
              className="right-1 bottom-1 absolute p-2 rounded-md focus-visible:ring ring-accent-green-100 duration-200 group"
                ...
                >
                  ...
                  <g id="SVGRepo_iconCarrier">
                    <path
                      ...
                      fill="#111"
                      className="group-hover:fill-black duration-300 fill-zinc-500"
                    ></path>
                  </g>
                </svg>
              ) : (
                  ...
                  <g id="SVGRepo_iconCarrier">
                    <g id="Edit / Hide">
                      <path
                        ...
                        stroke="#000000"
                        className="group-hover:stroke-black duration-300 stroke-zinc-500"
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      ></path>
          ...
          {oldPasswordError ? (
            <p className="mt-[-2px text-red-500 text-sm">{oldPasswordError}</p>
          ) : null}
        </div>
      </div>
      <div className="relative flex flex-col gap-1 border-zinc-100">
      ...
      <div className="flex flex-col gap-1 border-zinc-100">
        <label htmlFor="confirm-change-password" className="font-bold">
          Confirm Password
        </label>
        <div className="relative flex flex-col gap-2">
          <input
      ...
      <div className="flex sm:flex-row flex-col justify-between items-center mt-2">
        <button
