...
export default function UserDropdownMenu({
  ...
  return (
    <>
      <div
        className={`top-14 right-0 z-40 absolute bg-white border text-sm sm:text-base rounded-md min-w-60 aspect-square duration-300 ${
          dropdownIsOpen
      ...
      >
                  ...
                  <g id="Iconly/Curved/Profile">
                    <g id="Profile">
                      <path
                        ...
                        stroke="#222"
                        className="group-hover:stroke-accent-green-100 duration-300 stroke-zinc-700"
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      ></path>
        ...
        <div className="p-2">
          <button
            className="flex justify-center items-center gap-1 bg-red-500 hover:bg-red-600 p-2 rounded-md w-full text-white duration-300"
            onClick={() => {
      ...
      <SignoutModal
        open={signoutModalIsOpen}
        closeModal={() => setSignoutModalIsOpen(false)}
      />
    </>
  );
}
