    ...
    <ModalContainer closeModal={closeModal} open={open}>
      ...
      >
        ...
        <div className="flex justify-end items-center gap-2 bg-[#eee] p-2">
          <button
            className="border-zinc-200 bg-white hover:bg-zinc-100 px-4 p-2 border rounded-md text-zinc-700 duration-300"
            onClick={closeModal}
          >
            Cancel
          </button>
          <button className="bg-red-500 hover:bg-red-600 px-4 p-2 rounded-md text-white duration-300">
            Confirm
          </button>
        </div>
      </div>
